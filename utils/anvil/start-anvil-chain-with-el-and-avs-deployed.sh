...
# /home/abdullah/.foundry/bin/cast rpc anvil_mine 100 --rpc-url $RPC_URL
cast rpc anvil_mine 100 --rpc-url $RPC_URL
echo "advancing chain... current block-number:" $(/home/abdullah/.foundry/bin/cast block-number)

# Bring Anvil back to the foregroun
docker attach anvil